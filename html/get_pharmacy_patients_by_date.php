...
$sql = "SELECT PID, name, notes, status, created_date, next_visit_date FROM pharmacy_table WHERE next_visit_date = '$date'";
...
?>
<tr>
    <td colspan="7" class="text-center">No pharmacy patients found for this date.</td>
</tr>
<?php
endif;
?>