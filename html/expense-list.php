...
{
  $id=$_GET['did'];
  $sql2="update resource set active=1 where id='$id'";
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody>
    <?php
$sql2 = "SELECT * from resource where active=0";   
 $result2 = mysqli_query($conn, $sql2);
    ...
    ?>
        <tr>
            ...
            <td><?= $row2['barcode'] ?></td>
            <td><?= $row2['amount'] ?></td>
            <td><?= $row2['frequency'] ?></td>
            <!--<td><?= $row2['dedicate'] ?></td>-->
            <!--<td><?= $row2['marked'] ?></td>-->
            <!--<td><?= $row2['balance'] ?></td>-->
            <td><a href="expense-edit.php?eid=<?= $row2['id'] ?>">Edit</a></td>
            <td><a href="expense-list.php?did=<?= $row2['id'] ?>" onClick="return confirm('Are you sure you want to delete?')" style="color: purple; padding-left: 60px;">Delete</a></td>
        </tr>
    <?php
        }
    }
