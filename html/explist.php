...
{
  $id=$_GET['did'];
  $sql2="update entry set active=1 where invno='$id'";
  $res2=mysqli_query($conn,$sql2);
  header("Location: entry-list.php");
              ...
              <!-- <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody>
    <?php
$sql2 = "SELECT id, vendor, store, invno, barcode, product_name, indate, date_invoice, expiry_date, landing, qty, amount, total_billamount 
FROM entry 
WHERE active = 0 
GROUP BY invno 
ORDER BY invno";   
