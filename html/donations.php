...
{
  $id=$_GET['did'];
  $sql2="update ordertab set delete_status='1' where id='$id'";
    ...
    if ($extension == 'xlsx' || $extension == 'xls' || $extension == 'csv') {
        ...
        foreach ($data as $row) {
            ...
            if (mysqli_num_rows($checkResult) == 0) {
                $insert_query = "INSERT INTO receipt (recno, store ,mode,receiptdate,receiptno,donor,proname,amount,remindate,payment,reference,occation,active,added_by,indate)
                 VALUES ('$invno','$store','OUT','$recdate','$recno','$donor','$proname','$amount','$remindate','$payment','$reference','$occation',0,'$username','$in_date')";
...
<html
  ...
  <head>
    ...
    function download_table_as_csv(table_id) {
        ...
        var filename = 'donations_' + new Date().toLocaleDateString() + '.csv';
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">					
				<!-- <button type="submit" id="export_data" name='export_donation' value="Export to excel" class="btn btn-primary btn-lg">Download Donation list</button>
        <a href="donation-format.xlsx" download >  <button type="button" name="export-master-format" class="btn btn-secondary">Download UPload format</button></a> -->

			</form>
      <!-- <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-4">
                                    <h5 class="card-header">Upload Donation Data</h5>
                                    <div class="card-body">
            ...
            <!-- <div class="row">
              <div class="col-12">
                <table class="table table-bordered">
                  ...
                  $sql2 = "SELECT MIN(indate) AS indate, MIN(id) AS id, invoiceno, MIN(customer) AS customer, MIN(store) AS store, MIN(billamount) AS billamount FROM ordertab WHERE delete_status = 0 AND pr_status = 0  GROUP BY invoiceno ORDER BY invoiceno;";
            ...
            <?= $row2['customer'] ; ?>
                      ...
                      <td>
                       ...
                       <td>
                          ...
                          <a href="orderedit.php?id=<?=$row2['id']?>">Edit</a></td>
                     
                 <td>      <a href="billing.php?id=<?=$row2['invoiceno']?>" target=_blank>Print</a></td>
                   <td>  <a href="orders.php?id=<?=$row2['id']?>"onClick="return confirm('Are you sure you want to delete?')" style="color:purple;padding-left:60px;">Delete</a></td>  
