...
{
  $id=$_GET['id'];
  $sql2="select * from exphead where id='$id'";
...
if(isset($_POST['submit'])){
    $head=$_POST['category'];
    $query5="update exphead set head='$head' where id='$id'";  
    $result5=mysqli_query($conn,$query5);
    header("Location: exphead.php");
    echo '<script> window.location.href = "exphead.php"; </script>';
}  
?>                   
<!DOCTYPE html>
...
<html
  ...
  <!-- Bootstrap Table with Header - Dark -->
            ...
            <div class="col-md">
                  <div class="card mb-4">
                    <h5 class="card-header">Edit head</h5>
                    <div class="card-body">
                        <form method="post">
                      <div>
