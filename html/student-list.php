...
{
  $did=$_GET['did'];
  $sql2="update details set active=1 where id='$did'";
    ...
    if(isset($_POST['submit2'])){
        ...
        $headerSkipped = false;
            ...
            if (!$headerSkipped) {
                ...
                $doa=$row['8'];
                $course_details=$row['9'];
                $image=$row['10'];
                $remarks=$row['11'];
                $parents_username=$row['12'];
                $parents_password=$row['13'];
                $student_username=$row['14'];
                $student_password=$row['15'];
                ...
                $data = array(
                  ...
                  'remarks' => $remarks,
                  'parents_username' => $parents_username,
    ...
    <div class="layout-wrapper layout-content-navbar">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">					
				<button type="submit" id="export_data" name='export_data5' value="Export to excel" class="btn btn-primary btn-lg">Download Customer Details</button>
			</form><br>
      ...
      <form action="" enctype="multipart/form-data" method="post">
                  <input type="file" name="excel" value="" required>
                    ...
                    <button class="btn btn-primary btn-lg" type="submit" name="submit2">Add Customer</button>

                    


                    </form><br>
                    <a href="upload-students.xlsx" download style=""><button class="btn btn-primary btn-lg" type="button" >Download Customer upload format</button></a><br><br>
                      ...
                      <tr>
                        ...
                        <div
                            ...
                            <div class="btn-group" role="group" aria-label="First group">
                              ...
                              <a href="actions.php?id=<?=$row['id']?>"><button type="button" class="btn btn-outline-secondary">
