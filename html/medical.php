...
<!-- Your page content goes here -->
        ...
        <div class="section-header">
            <div class="header-content">
                <div>
                    <h1 class="section-title" id="sectionTitle">Patients for Medical</h1>
                    <p class="section-subtitle" id="sectionSubtitle">Manage medical consultations and patient care</p>
                </div>
        ...
        <div class="patient-table-container">
            <table class="patient-table">
                ...
                <tbody id="nursingTableBody">
                   <?php
                       $sql    = "SELECT PID, name, notes, status, created_date FROM reception WHERE status IN ('MEDICAL')";
...
function callPatient(pid) {
    ...
    if ('speechSynthesis' in window) {
        try {
            ...
            const message = `Patient ${pid} ${patientName} please go to room 3`;
...
function updatePatientStatus(pid) {
    ...
    if (statusSelect && notesInput) {
        ...
        console.log(`Updating patient ${pid}: Status=${status}, Notes=${notes}`);

        // Placeholder alert
        alert(`Patient ${pid} status updated to: ${status}`);
    }
}
