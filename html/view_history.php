...
<html lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="../assets/" data-template="vertical-menu-template-free">
  ...
  <body>
    ...
    // If an id is provided, filter the result by id
    $sql2 = "SELECT * FROM actual_expense WHERE id = $id";   
                    ...
                    <tr>
                      ...
                      <td><?php echo $row2['sub_particulars']; ?></td>
                      <td><?php echo $row2['amount']; ?></td>
                      <td>
                        <a href="edit_actual.php?id=<?php echo $row2['slno']; ?>" class="btn btn-primary btn-sm">Edit</a>
                        <a href="delete_actual.php?id=<?php echo $row2['slno']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this expense?');">Delete</a>
                      </td>
                    </tr>
                    <?php
                        }
