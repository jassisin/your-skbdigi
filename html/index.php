        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card p-2">
            ...
            <div class="card-body mt-2">
              ...
              <p class="mb-4">  നിങ്ങളുടെ ഉപഭോക്താക്കളുമായിട്ടുള്ള ബന്ധം മെച്ചപ്പെടുത്തുന്നതിനുളള സോഫ്റ്റ് പോർട്ടലിലേക്ക് സ്വാഗതം</p>
              ...
              <form  class="mb-3" method="post" action="login.php">
                ...
                <!-- <div class="form-check">
                  ...
                  <a href="auth-forgot-password-basic.html" class="float-end mb-1">
                    <span>Forgot<div class="mb-3 d-flex justify-content-between">
                   Password?</span>
                  </a>
                </div> -->
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit" name="submit">Log in</button>
                  <p class="mb-4">Powered by SBK Digi</p>
                </div>
              </form>
