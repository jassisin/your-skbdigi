...
if(isset($_POST['submit'])){
  ...
  $s_vendor1=$_POST['vendor'];
  $s_vendor=mysqli_real_escape_string($conn,$s_vendor1);
  $s_store=$_POST['store'];
  $s_mode=$_POST['mode'];
  $s_invno=$_POST['invno'];
  $s_date=$_POST['date'];
...
if($s_mode=='TRANSFER'){
  ...
  $data = array(
   ...
   if(mysqli_num_rows($res3)>=1){
    $row3=$row2=mysqli_fetch_array($res3);
    $transfer_out=$row3['tranfer_out'];
    if($transfer_out==NULL){
      $transfer_out=0;
    }
   $closing_stock=$row3['closing_stock'];
   if($closing_stock=$row3==NULL){
    $closing_stock=$row3=0;
   }
   $transout=$transfer_out+$s_qty;
   $closestock2=$closing_stock-$s_qty;
   $data = array(
    
    'tranfer_out' => $transout,
    'closing_stock' => $closestock2,
    'add_date' => $indate,
    'mode'  => $s_mode,
    );
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <option value="--select store--">Store</option>
