...
<!-- Your page content goes here -->
        ...
        <div class="section-header">
            <div class="header-content">
                <div>
                    <h1 class="section-title" id="sectionTitle">Patients for Dental</h1>
                    <p class="section-subtitle" id="sectionSubtitle">Manage dental consultations and patient care</p>
                </div>
...
fetchPatientCountsAndRender(currentDate);
    ...
    el.onclick = () => {
       if (count > 0) {
        fetchDentalPatientsByDate(fullDate);
       }
     };        calendarGrid.appendChild(el);
      }
...
function fetchDentalPatientsByDate(dateStr) {
    fetch('get_dental_patients_by_date.php?date=' + encodeURIComponent(dateStr))
...
function updatePatientStatus(pid) {
    ...
    if (statusSelect && notesInput && nextDateInput) {
        ...
        fetch('update_dental_patient.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
