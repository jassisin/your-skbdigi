...
if(isset($_POST["submit"])){
    ...
    $query="update customer set Fullname='$cusname',Email='$email',Mobile_no='$phone',Pincode='$pincode',Cusaddress='$address' where id='$id'";  
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="post">
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" id="basic-default-fullname" name="email" placeholder="John Doe" value="<?=$email?>"/>
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                          <input
                            ...
                            placeholder="658 799 8941" name="phone" value="<?=$mobile?>"/>
                          <label for="basic-default-phone">Phone No</label>
                        </div>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" id="basic-default-fullname" name="pincode" placeholder="John Doe" value="<?=$pincode?>"/>
